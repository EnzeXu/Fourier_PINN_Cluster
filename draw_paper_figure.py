...
def draw_paper_figure_loss(**kwargs):
    ...
    for i, one_model_group in enumerate(timestring_dict.keys()):
        ...
        # print(ys.shape)
        plt.plot((x * mask_gap)[start_index:], y_mean[start_index:], c=default_color_list[i], linewidth=3, label=one_model_group)
...
def one_time_plot_rep6(time_string=None, all_flag=False):
    ...
    time_string = get_now_string() if not time_string else time_string
    timestring_dict = {
        "SB-FNN (gelu)": ["20230128_065608_271045", "20230128_075132_332564"],#"20230128_060203_658882"
        "SB-FNN (gelu+boundary)": ["20230129_150002_345927", "20230129_155748_133988", "20230129_165341_618691"],
        "SB-FNN (gelu+cyclic)": ["20230129_150002_309968", "20230129_155545_087400", "20230129_165126_279015"],
...
#     """,
    "SB-FNN (gelu)": """
    20230128_060203_658882
20230128_065608_271045
20230128_075132_332564
    """,
    "SB-FNN (gelu+boundary)": """
    20230128_114642_713940
20230128_124432_743158
20230128_134129_446552
    """,
    "SB-FNN (gelu+cyclic)": """
    20230128_115614_896365
20230128_125726_637696
20230128_135817_636549
    """,
#     "SB-FNN (gelu)": """
#     20230125_160242_190270
# 20230125_181935_084463
# 20230125_112612_446592
#     """,
#     "SB-FNN (relu)": """
#     20230125_172100_002889
# 20230125_194953_077806
# 20230125_112640_653662
#     """,
#     "SB-FNN (sin)": """
#     20230125_203701_838486
# 20230125_225457_237637
# 20230125_134329_806003
#     """,
#     "SB-FNN (softplus)": """
#     20230125_204723_511250
# 20230125_225922_839450
# 20230125_134451_366695
#     """,
#     "SB-FNN (tanh)": """
#     20230125_203432_142685
# 20230125_224345_685056
# 20230125_133456_936209
#     """,
}
