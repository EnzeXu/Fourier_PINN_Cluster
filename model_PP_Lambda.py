...
class FourierModel(nn.Module):
    ...
    def ode_gradient(self, x, y):
        ...
        return u_t - (self.config.params.alpha - self.config.params.gamma * v) * u, v_t - (
                self.config.params.delta * u - self.config.params.beta) * v
    ...
    def train_model(self):
        ...
        scheduler = torch.optim.lr_scheduler.LambdaLR(optimizer, lr_lambda=lambda e: 1 / (e / 2000 + 1))
        self.train()
