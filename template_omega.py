...
class FourierModelTemplate(nn.Module):
    ...
    def train_model(self):
        ...
        assert self.config.scheduler in ["cosine", "decade", "decade_pp", "fixed"]
...
def run(config, fourier_model, pinn_model):
    ...
    parser.add_argument("--scheduler", type=str, default="cosine", choices=["cosine", "decade", "decade_pp", "fixed"], help="scheduler")
